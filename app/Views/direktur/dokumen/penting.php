...
<div class="container-fluid py-3 py-md-4">
    ...
    <div class="d-flex justify-content-between align-items-center bg-white rounded-3 shadow-sm p-3 mb-3 border border-light header-mobile-flex gap-3">
        ...
        <div>
            <a href="<?= base_url('direktur/dokumen/penting/tambah') ?>" class="btn btn-primary rounded-pill shadow-sm d-inline-flex align-items-center text-sm fw-semibold">
    ...
    <div class="card dokumen-card-modern p-3 p-md-4 mb-3">
        <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-3 flex-wrap gap-2">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="<?= base_url('direktur/dokumen/penting/tambah') ?>" class="btn btn-sm btn-primary rounded-pill px-3 fw-semibold text-nowrap shadow-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                <div class="d-flex align-items-center justify-content-center gap-1">
                                    <a href="<?= base_url('direktur/dokumen/penting/detail/'.$d['id']) ?>" class="btn btn-xs btn-outline-info rounded-pill px-2.5 py-1 text-xs fw-semibold" title="Detail Dokumen">
                                        <i class="fas fa-eye me-1"></i> Detail
                                    </a>
                                    <a href="<?= base_url('direktur/dokumen/penting/edit/'.$d['id']) ?>" class="btn btn-xs btn-outline-warning rounded-pill px-2.5 py-1 text-xs fw-semibold" title="Edit Dokumen">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            <div class="modal-header bg-gradient-primary text-white rounded-top-4 py-3 px-4">
                <h5 class="modal-title fs-6 fw-bold mb-0"><i class="fas fa-upload me-2"></i> Upload Dokumen Penting Baru</h5>
            ...
            <form action="<?= base_url('direktur/dokumen/penting/simpan') ?>" method="POST" enctype="multipart/form-data" onsubmit="const btn = this.querySelector('button[type=submit]'); if(btn){ btn.disabled = true; btn.innerHTML = '<i class=\'fas fa-spinner fa-spin me-1\'></i> Mengunggah...'; }">
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold text-xs text-dark">Kadaluarsa (Kosongkan jika Permanen)</label>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted text-xs">Format didukung: PDF, PNG, JPG (Maks. 5MB)</small>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold text-xs text-dark">Keterangan Singkat</label>
                        <textarea class="form-control rounded-3" name="keterangan" rows="2" placeholder="Catatan mengenai berkas atau perpanjangan..."></textarea>
                    </div>
                </div>
...
function confirmDeleteDokumen(id, nama) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = '<?= base_url('direktur/dokumen/penting/delete') ?>/' + id;
