<?php
// app/Views/direktur/proyek/timeline_tambah.php

$title = $title ?? 'Buat Project Timeline Baru';
$templateData = [
    'title' => $title,
    'active' => 'proyek'
];
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1 text-xs">
                    ...
                    <li class="breadcrumb-item active text-primary fw-bold" aria-current="page">Buat Timeline Proyek</li>
                </ol>
            </nav>
            <h4 class="fw-bold text-dark mb-0"><i class="fas fa-plus-circle text-primary me-2"></i> Tambah Project Timeline Aktif</h4>
            <small class="text-muted">Buat proyek baru yang langsung berstatus 'On Progress' untuk mulai dijadwalkan timelinenya.</small>
        </div>
        <div>
            <a href="<?= base_url('direktur/proyek/timeline') ?>" class="btn btn-outline-secondary rounded-pill px-3 shadow-sm text-sm font-semibold">
                <i class="fas fa-arrow-left me-1.5"></i> Kembali ke Timeline
            </a>
        </div>
    </div>
        ...
        <div class="col-lg-9">
            <div class="card border-0 rounded-4 shadow-lg overflow-hidden mb-4">
                <div class="card-header bg-gradient-primary text-white py-3 px-4">
                    <h5 class="card-title fs-6 fw-bold mb-0"><i class="fas fa-stream me-2"></i> Form Timeline Proyek Baru</h5>
                </div>
                <form action="<?= base_url('direktur/proyek/timeline/simpan') ?>" method="POST" onsubmit="const btn = this.querySelector('button[type=submit]'); if(btn){ btn.disabled = true; btn.innerHTML = '<i class=\'fas fa-spinner fa-spin me-1\'></i> Menyimpan...'; }">
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <small class="text-muted text-xs">Pilih dari proyek terdahulu atau ketik nama baru.</small>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-xs text-dark">Deskripsi Scope Kerja</label>
                            <textarea class="form-control rounded-3" name="deskripsi" rows="3" placeholder="Deskripsi mengenai ruang lingkup kerja project..."></textarea>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control rounded-3" name="tanggal_mulai" required value="<?= date('Y-m-d') ?>">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold text-xs text-dark">Status Default</label>
                                <input type="text" class="form-control rounded-3 bg-light text-primary fw-bold" value="On Progress (Sedang Berjalan)" readonly>
                            </div>
                        </div>

                    </div>
                    <div class="card-footer bg-light px-4 py-3 text-end rounded-bottom-4">
                        <a href="<?= base_url('direktur/proyek/timeline') ?>" class="btn btn-secondary rounded-pill px-4 me-2 font-semibold">Batal</a>
                        <button type="submit" class="btn btn-primary rounded-pill px-4 font-semibold shadow-sm">
                            <i class="fas fa-save me-1.5"></i> Simpan Project Timeline
                        </button>
                    </div>
                </form>
            </div>
