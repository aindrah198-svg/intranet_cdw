<?php
// app/Views/direktur/proyek/baru_tambah.php
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1 text-xs">
                    ...
                    <li class="breadcrumb-item active text-primary fw-bold" aria-current="page">Buat Project</li>
                </ol>
            </nav>
            <h4 class="fw-bold text-dark mb-0"><i class="fas fa-plus-circle text-primary me-2"></i> Buat Inisiasi Project Baru</h4>
            <small class="text-muted">Inisiasi data penawaran, negosiasi, atau kesepakatan deal project baru CDW.</small>
        </div>
        <div>
        ...
        <div class="col-lg-9">
            <div class="card border-0 rounded-4 shadow-lg overflow-hidden mb-4">
                <div class="card-header bg-gradient-primary text-white py-3 px-4">
                    <h5 class="card-title fs-6 fw-bold mb-0"><i class="fas fa-project-diagram me-2"></i> Form Inisiasi Project</h5>
                </div>
                <form action="<?= base_url('direktur/proyek/simpan') ?>" method="POST" onsubmit="const btn = this.querySelector('button[type=submit]'); if(btn){ btn.disabled = true; btn.innerHTML = '<i class=\'fas fa-spinner fa-spin me-1\'></i> Menyimpan...'; }">
