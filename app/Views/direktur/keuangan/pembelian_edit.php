<?php
$title = $title ?? 'Edit Pencatatan Pembelian';
$templateData = [
    'title' => $title,
...
<div class="container-fluid py-3 py-md-4">
    ...
    <div class="d-flex justify-content-between align-items-center bg-white rounded-3 shadow-sm p-3 mb-4 border border-light flex-wrap gap-3">
        <div class="d-flex align-items-center">
            <a href="<?= base_url('direktur/keuangan/pembelian/detail/' . $p['id']) ?>" class="btn btn-outline-secondary rounded-pill me-3 px-3 py-1.5 text-xs fw-semibold">
        ...
        <div class="card pr-form-card p-4 mb-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    $isPaidVal = ($stB === 'dibayar / lunas' || $stB === 'lunas' || $stB === 'dibayar');
                    ?>
            ...
            <div class="mt-4 pt-3 border-top text-end">
                <a href="<?= base_url('direktur/keuangan/pembelian/detail/' . $p['id']) ?>" class="btn btn-light rounded-pill px-4 me-2 border">Batal</a>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Auto Sync Status Penerimaan, Status Pembayaran & Status Keseluruhan
