<?php
// app/Views/direktur/pengadaan/gudang_tambah.php

$title = $title ?? 'Tambah Barang Gudang Baru';
$templateData = [
    'title' => $title,
    'active' => 'pengadaan'
];
    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            <div class="card border-0 rounded-4 shadow-lg overflow-hidden mb-4">
                ...
                <form action="<?= base_url('direktur/pengadaan/gudang/simpan') ?>" method="POST" enctype="multipart/form-data" onsubmit="const btn = this.querySelector('button[type=submit]'); if(btn){ btn.disabled = true; btn.innerHTML = '<i class=\'fas fa-spinner fa-spin me-1\'></i> Menyimpan...'; }">
                    <div class="card-body p-4">
                        
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold text-xs text-dark">Kode Barang (Otomatis Sistem)</label>
                                <input type="text" class="form-control rounded-3 bg-light fw-bold text-primary" name="kode_barang" value="<?= esc($autoKode) ?>" readonly title="Kode barang di-generate otomatis oleh sistem">
