...
function renderLivePreview() {
    ...
    pages.forEach((pageBlocks, pi) => {
        ...
        let pageNumIndicator = `<div style="position:absolute;bottom:18px;right:30px;font-size:0.82rem;font-weight:700;color:#1e3c72;z-index:5;text-align:right;">Halaman ${pageNum} dari ${pages.length}</div>`;
        ...
        if (isFirstPage) {
            paperHtml += `<div style="margin-bottom:16px;position:relative;z-index:3;">${kopHtml}</div>`;
