        ...
        <ul class="nav flex-column" style="list-style: none; padding: 0; margin: 0;">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $isPenggajianActive ? 'active' : '' ?>" 
                   data-bs-toggle="collapse" href="#penggajianMenu" role="button" aria-expanded="<?= $isPenggajianActive ? 'true' : 'false' ?>"
                   style="color: rgba(255,255,255,0.8); padding: 10px 20px; text-decoration: none; display: flex; align-items: center; justify-content: space-between; cursor: pointer; <?= $isPenggajianActive ? 'background: rgba(255,255,255,0.1); border-left: 3px solid #4dabf7;' : '' ?>">
                    <div><i class="fas fa-money-check-alt me-2" style="width: 20px;"></i><span>Penggajian</span></div>
                    <i class="fas fa-chevron-down" style="font-size: 0.75rem; <?= $isPenggajianActive ? 'transform: rotate(180deg);' : '' ?>"></i>
                </a>
                <div class="collapse <?= $isPenggajianActive ? 'show' : '' ?>" id="penggajianMenu" style="background: rgba(0,0,0,0.15);">
                    <ul class="nav flex-column" style="padding: 2px 0; list-style: none;">
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/penggajian/perhitungan-gaji') ?>"><i class="fas fa-search-dollar me-2"></i>Review Payroll (HRD)</a></li>
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/penggajian/proses-pembayaran') ?>"><i class="fas fa-credit-card me-2"></i>Proses Pembayaran</a></li>
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/penggajian/slip-gaji-laporan') ?>"><i class="fas fa-file-contract me-2"></i>Slip Gaji & Laporan</a></li>
                    </ul>
                </div>
            </li>
            ...
            <!-- Kasbon (NEW) -->
            <li class="nav-item">
                <a class="nav-link <?= $isKasbonActive ? 'active' : '' ?>" 
                   data-bs-toggle="collapse" href="#kasbonMenu" role="button" aria-expanded="<?= $isKasbonActive ? 'true' : 'false' ?>"
                   style="color: rgba(255,255,255,0.8); padding: 10px 20px; text-decoration: none; display: flex; align-items: center; justify-content: space-between; cursor: pointer; <?= $isKasbonActive ? 'background: rgba(255,255,255,0.1); border-left: 3px solid #4dabf7;' : '' ?>">
                    <div><i class="fas fa-hand-holding-usd me-2" style="width: 20px;"></i><span>Kasbon</span></div>
                    <i class="fas fa-chevron-down" style="font-size: 0.75rem; <?= $isKasbonActive ? 'transform: rotate(180deg);' : '' ?>"></i>
                </a>
                <div class="collapse <?= $isKasbonActive ? 'show' : '' ?>" id="kasbonMenu" style="background: rgba(0,0,0,0.15);">
                    <ul class="nav flex-column" style="padding: 2px 0; list-style: none;">
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/kasbon') ?>"><i class="fas fa-list me-2"></i>Daftar Kasbon (Direktur)</a></li>
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/kasbon/potong-gaji') ?>"><i class="fas fa-calculator me-2"></i>Proses Potong Gaji</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link <?= $isAsetTetapActive ? 'active' : '' ?>" 
                   data-bs-toggle="collapse" href="#asetTetapMenu" role="button" aria-expanded="<?= $isAsetTetapActive ? 'true' : 'false' ?>"
                   style="color: rgba(255,255,255,0.8); padding: 10px 20px; text-decoration: none; display: flex; align-items: center; justify-content: space-between; cursor: pointer; <?= $isAsetTetapActive ? 'background: rgba(255,255,255,0.1); border-left: 3px solid #4dabf7;' : '' ?>">
                    <div><i class="fas fa-building me-2" style="width: 20px;"></i><span>Aset Tetap</span></div>
                    <i class="fas fa-chevron-down" style="font-size: 0.75rem; <?= $isAsetTetapActive ? 'transform: rotate(180deg);' : '' ?>"></i>
                </a>
                <div class="collapse <?= $isAsetTetapActive ? 'show' : '' ?>" id="asetTetapMenu" style="background: rgba(0,0,0,0.15);">
                    <ul class="nav flex-column" style="padding: 2px 0; list-style: none;">
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/aset-tetap/register-aset') ?>"><i class="fas fa-clipboard-list me-2"></i>Register Aset (Direktur)</a></li>
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/aset-tetap/penyusutan') ?>"><i class="fas fa-chart-line me-2"></i>Penyusutan</a></li>
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/aset-tetap/pelepasan-aset') ?>"><i class="fas fa-trash-alt me-2"></i>Pelepasan Aset</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link <?= $isPajakActive ? 'active' : '' ?>" 
                   data-bs-toggle="collapse" href="#pajakMenu" role="button" aria-expanded="<?= $isPajakActive ? 'true' : 'false' ?>"
                   style="color: rgba(255,255,255,0.8); padding: 10px 20px; text-decoration: none; display: flex; align-items: center; justify-content: space-between; cursor: pointer; <?= $isPajakActive ? 'background: rgba(255,255,255,0.1); border-left: 3px solid #4dabf7;' : '' ?>">
                    <div><i class="fas fa-file-invoice-dollar me-2" style="width: 20px;"></i><span>Manajemen Pajak</span></div>
                    <i class="fas fa-chevron-down" style="font-size: 0.75rem; <?= $isPajakActive ? 'transform: rotate(180deg);' : '' ?>"></i>
                </a>
                <div class="collapse <?= $isPajakActive ? 'show' : '' ?>" id="pajakMenu" style="background: rgba(0,0,0,0.15);">
                    <ul class="nav flex-column" style="padding: 2px 0; list-style: none;">
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/manajemen-pajak/ppn') ?>"><i class="fas fa-percentage me-2"></i>PPN</a></li>
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/manajemen-pajak/pph-badan') ?>"><i class="fas fa-landmark me-2"></i>PPh Badan</a></li>
                        <li><a class="nav-link py-2 ps-4 text-white-50" href="<?= site_url('accounting/manajemen-pajak/arsip-pajak') ?>"><i class="fas fa-archive me-2"></i>Arsip Pajak</a></li>
                    </ul>
                </div>
            </li>
