...
<div class="container-fluid px-3 px-md-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?= base_url('admin/dokumen/sertifikat/edit/'.$s['id']) ?>" class="btn btn-warning text-white rounded-pill px-3 shadow-sm text-sm font-semibold">
        ...
        <div class="col-lg-9">
            <div class="card border-0 rounded-4 shadow-lg overflow-hidden mb-4">
                ...
                <div class="card-footer bg-light px-4 py-3 text-end rounded-bottom-4">
                    <a href="<?= base_url('admin/dokumen/sertifikat') ?>" class="btn btn-secondary rounded-pill px-4 font-semibold me-2">Kembali</a>
                    <a href="<?= base_url('admin/dokumen/sertifikat/edit/'.$s['id']) ?>" class="btn btn-warning text-white rounded-pill px-4 font-semibold shadow-sm">
