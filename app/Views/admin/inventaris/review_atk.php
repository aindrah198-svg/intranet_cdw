...
<div class="container-fluid py-3 py-md-4">
    ...
    <div class="d-flex justify-content-between align-items-center bg-white rounded-3 shadow-sm p-3 mb-4 border border-light flex-wrap gap-3">
        <div class="d-flex align-items-center">
            <a href="<?= base_url('admin/inventaris/pengajuan-atk') ?>" class="btn btn-outline-secondary rounded-pill me-3 px-3 py-1.5 text-xs fw-semibold">
                <i class="fas fa-arrow-left me-1.5"></i> Kembali
            </a>
            <div>
                <h4 class="mb-0 fw-bold text-dark fs-5 fs-md-4">Review & Approval Pengajuan ATK</h4>
                <small class="text-muted d-none d-sm-inline">Tinjau rincian kebutuhan Alat Tulis Kantor dan berikan keputusan Admin / Manajemen.</small>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card laporan-card-modern p-4">
                ...
                <div class="bg-light p-3.5 rounded-3 border mb-4">
                    <div class="row g-3 text-sm">
                        <div class="col-12 col-sm-6">
                            ...
                            <strong class="text-dark fs-6"><?= esc($p['nama_lengkap'] ?? 'Admin Panel') ?></strong>
                ...
                <!-- Form Keputusan Admin / Direktur -->
                <form action="<?= base_url('admin/inventaris/pengajuan-atk/approve') ?>" method="POST">
                    <input type="hidden" name="id" value="<?= esc($p['id']) ?>">

                    <h6 class="fw-bold text-dark mb-3"><i class="fas fa-edit text-primary me-2"></i> Keputusan Persetujuan</h6>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold text-xs text-dark">Catatan / Komentar Admin</label>
                        <textarea name="komentar" class="form-control rounded-3 p-3" rows="4" placeholder="Masukkan catatan atau instruksi tambahan untuk staf..."><?= esc($p['komentar_direktur'] ?? '') ?></textarea>
                    </div>

                    <div class="d-flex justify-content-end gap-2 border-top pt-3">
                        <a href="<?= base_url('admin/inventaris/pengajuan-atk') ?>" class="btn btn-outline-secondary rounded-pill px-4 py-2 text-sm">Batal</a>
