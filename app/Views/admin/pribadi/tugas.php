                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if($totalItems > 0): ?>
                                    ...
                                    <div class="progress rounded-pill style-progress" style="height: 6px; width: 120px; margin: 0 auto;">
                            ...
                            <td class="text-center text-nowrap">
                                ...
                                <?php if(!empty($t['tenggat_waktu'])): ?>
                                    <div class="text-xs text-danger font-semibold"><i class="far fa-clock me-1"></i><?= date('H:i', strtotime($t['tenggat_waktu'])) ?> WIB</div>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="pe-4 text-end text-nowrap">
                                <div class="d-inline-flex gap-1.5 align-items-center">
                                    <!-- Detail & Edit Sub-item Button -->
                                    <a href="<?= base_url('admin/tugas-saya/detail/'.$t['id']) ?>" class="btn btn-outline-primary btn-sm rounded-pill px-3 fw-semibold text-xs" title="Lihat Detail & Edit Checklist">
                                    ...
                                    <?php else: ?>
                                        <button type="button" class="btn btn-secondary btn-sm rounded-pill px-3 text-xs opacity-60" onclick="alertNotCompleted()" title="Selesaikan seluruh sub-item terlebih dahulu">
