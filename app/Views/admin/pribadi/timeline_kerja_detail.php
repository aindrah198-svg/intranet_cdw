<?php
$data = [
    'title'  => 'Detail Timeline: ' . ($project['nama_project'] ?? 'Proyek'),
...
<div class="container-fluid px-3 px-md-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1 text-xs">
                    <li class="breadcrumb-item"><a href="<?= base_url('admin/timeline-kerja') ?>" class="text-decoration-none text-muted">Timeline Kerja</a></li>
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="<?= base_url('admin/timeline-kerja') ?>" class="btn btn-outline-secondary rounded-pill px-3 shadow-sm text-sm font-semibold">
                        ...
                        <?php else: ?>
                            ...
                            <tr class="timeline-row" data-periode="<?= $tipePeriode ?>">
                                ...
                                <td>
                                    ...
                                    <form action="<?= base_url('admin/timeline-kerja/update_task_status') ?>" method="POST" class="d-inline">
...
<div class="modal fade" id="tambahTaskModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            ...
            <form action="<?= base_url('admin/timeline-kerja/simpan_task') ?>" method="POST" onsubmit="const btn = this.querySelector('button[type=submit]'); if(btn){ btn.disabled = true; btn.innerHTML = '<i class=\'fas fa-spinner fa-spin me-1\'></i> Menyimpan...'; }">
    ...
    function confirmSelesaikanProyekDetail(id, nama) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = '<?= base_url('admin/timeline-kerja/selesaikan') ?>/' + id;
    ...
    function confirmDeleteTask(id, nama) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = '<?= base_url('admin/timeline-kerja/delete_task') ?>/' + id;
                document.body.appendChild(form);
                form.submit();
            }
        });
