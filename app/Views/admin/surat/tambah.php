...
<div class="container-fluid py-3 py-md-4">
    ...
    <div class="d-flex justify-content-between align-items-center bg-white rounded-3 shadow-sm p-3 mb-4 border border-light">
        ...
        <a href="<?= base_url('admin/surat') ?>" class="btn btn-outline-secondary rounded-pill px-3.5 py-2 shadow-sm d-inline-flex align-items-center text-sm fw-semibold">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-xl-5">
            <div class="card employee-card-modern p-4 mb-4">
                ...
                <form action="<?= base_url('admin/surat/simpan') ?>" method="post" id="suratForm">
                    <?= csrf_field() ?>
                    ...
                    <div id="signatureFieldsContainer" class="p-3 bg-light rounded-3 border mb-4 shadow-xs">
                        ...
                        <div id="p1Fields" class="row g-2 mb-3">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="pihak_1_title" id="pihak1Title" class="form-control form-control-sm" placeholder="Judul (misal: Hormat kami,)" value="Hormat kami," oninput="renderLivePreview()">
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="pihak_1_nama" id="pihak1Nama" class="form-control form-control-sm" placeholder="Nama / Perusahaan" value="PT. CIPTA DUTA WACANA" oninput="renderLivePreview()">
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="pihak_1_jabatan" id="pihak1Jabatan" class="form-control form-control-sm" placeholder="Jabatan" value="Direktur Utama" oninput="renderLivePreview()">
                            </div>
                            <div class="col-md-3">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="hidden" name="pihak_1_img" id="pihak1ImgVal" value="">
                        ...
                        <!-- Pihak 2 -->
                        <div id="p2Fields" class="row g-2 mb-3 d-none">
                            ...
                            <div class="col-md-3">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="hidden" name="pihak_2_img" id="pihak2ImgVal" value="">
                        ...
                        <div id="p3Fields" class="row g-2 d-none">
                            ...
                            <div class="col-md-3">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="hidden" name="pihak_3_img" id="pihak3ImgVal" value="">
...
function renderLivePreview() {
    ...
    // Decompose text blocks for pagination so multi-paragraph text splits gracefully (tables remain whole intact blocks)
    const renderBlocks = [];
    blocks.forEach(b => {
        if (b.type === 'text') {
