...
<body>
    ...
    <div class="preview-action-bar no-print">
        <div class="d-flex align-items-center gap-3">
            <a href="<?= base_url('admin/surat/detail/' . $surat['id']) ?>" class="btn btn-outline-light btn-sm rounded-pill px-3 fw-semibold">
                <i class="fas fa-arrow-left me-1.5"></i> Kembali ke Detail
            </a>
            <span class="badge bg-warning text-dark fw-bold px-3 py-2 rounded-pill">
                <i class="fas fa-file-invoice me-1"></i> Mode Pratinjau Standalone (Admin)
            </span>
        </div>
