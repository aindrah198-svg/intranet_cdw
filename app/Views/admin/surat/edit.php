...
<div class="container-fluid py-3 py-md-4">
    ...
    <div class="d-flex justify-content-between align-items-center bg-white rounded-3 shadow-sm p-3 mb-4 border border-light">
        ...
        <a href="<?= base_url('admin/surat/detail/' . $surat['id']) ?>" class="btn btn-outline-secondary rounded-pill px-3.5 py-2 shadow-sm d-inline-flex align-items-center text-sm fw-semibold">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-xl-5">
            <div class="card employee-card-modern p-4 mb-4">
                ...
                <form action="<?= base_url('admin/surat/update/' . $surat['id']) ?>" method="post" id="suratForm">
                    <?= csrf_field() ?>
