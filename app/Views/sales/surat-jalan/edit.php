...
// Gunakan old data jika ada, jika tidak gunakan data dari database
function getFieldValue($fieldName, $defaultValue = '') {
    ...
    global $suratJalan;
    return $suratJalan[$fieldName] ?? $defaultValue;
}

// Format items data untuk JavaScript
$jsItems = [];
if (!empty($items)) {
    foreach ($items as $item) {
        $jsItems[] = [
            ...
            'satuan' => $item['satuan'],
            'berat' => $item['berat'],
            'keterangan' => $item['keterangan'] ?? 'Sudah di rakit'
        ];
    }
}
?>
...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            <div class="page-header">
                ...
                <p class="lead text-muted">
                    <?= $subtitle ?? 'Edit data surat jalan' ?>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <form action="<?= base_url('sales/surat-jalan/update/' . ($suratJalan['id'] ?? '')) ?>" method="POST" id="suratJalanForm">
                <?= csrf_field() ?>
                
                <input type="hidden" name="disiapkan_oleh" value="<?= getFieldValue('disiapkan_oleh', $karyawanData['nama_lengkap'] ?? 'Dwi Sales Pratama') ?>">
                <input type="hidden" name="disiapkan_telepon" value="<?= getFieldValue('disiapkan_telepon', $karyawanData['telepon'] ?? '081234567891') ?>">
                <input type="hidden" name="disiapkan_jabatan" value="<?= getFieldValue('disiapkan_jabatan', $karyawanData['jabatan'] ?? 'Sales Executive') ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" 
                                           ...
                                           id="tanggal_kirim" 
                                           name="tanggal_kirim" 
                                           value="<?= !empty($suratJalan['tanggal_kirim']) ? date('Y-m-d', strtotime($suratJalan['tanggal_kirim'])) : '' ?>" 
                                           required>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" 
                   ...
                   id="project_manual" 
                   name="project_manual" 
                   value="<?= htmlspecialchars(old('project_manual', $projectName ?? '')) ?>" 
                   placeholder="Masukkan nama project"
                   required>
            <input type="hidden" name="project_id" value="<?= $suratJalan['project_id'] ?? '' ?>">
            <?php if ($validation->hasError('project_manual')): ?>
                <div class="invalid-feedback">
                    <?= $validation->getError('project_manual') ?>
                </div>
            <?php endif; ?>
            <small class="text-muted">Masukkan nama project secara manual</small>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="invoice_manual" class="form-label fw-bold">
                <i class="fas fa-file-invoice me-2"></i>Invoice (Opsional)
            </label>
            <input type="text" 
                   class="form-control" 
                   id="invoice_manual" 
                   name="invoice_manual" 
                   value="<?= htmlspecialchars(old('invoice_manual', $invoiceNumber ?? '')) ?>"
                   placeholder="Masukkan nomor invoice">
            <input type="hidden" name="invoice_id" value="<?= $suratJalan['invoice_id'] ?? '' ?>">
            <small class="text-muted">Masukkan nomor invoice secara manual</small>
        </div>
    </div>
</div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <p class="mb-1" id="displayDisiapkanOleh"><?= htmlspecialchars(getFieldValue('disiapkan_oleh', $karyawanData['nama_lengkap'] ?? 'Dwi Sales Pratama')) ?></p>
                                                <small class="text-muted">(Otomatis dari data karyawan)</small>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="fw-bold">Telepon</h6>
                                                <p class="mb-1" id="displayDisiapkanTelepon"><?= htmlspecialchars(getFieldValue('disiapkan_telepon', $karyawanData['telepon'] ?? '081234567891')) ?></p>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="fw-bold">Jabatan</h6>
                                                <p class="mb-1" id="displayDisiapkanJabatan"><?= htmlspecialchars(getFieldValue('disiapkan_jabatan', $karyawanData['jabatan'] ?? 'Sales Executive')) ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?= htmlspecialchars($suratJalan['penerima_perusahaan'] ?? '') ?>" 
                                           required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="penerima_up" 
                                           name="penerima_up" 
                                           value="<?= htmlspecialchars($suratJalan['penerima_up'] ?? '') ?>" 
                                           required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="penerima_nama" 
                                           name="penerima_nama" 
                                           value="<?= htmlspecialchars($suratJalan['penerima_nama'] ?? $suratJalan['penerima_up'] ?? '') ?>"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?= htmlspecialchars($suratJalan['penerima_telepon'] ?? '') ?>"
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control <?= ($validation->hasError('alamat_pengiriman')) ? 'is-invalid' : '' ?>" 
                                              ...
                                              rows="3" 
                                              required><?= htmlspecialchars($suratJalan['alamat_pengiriman'] ?? '') ?></textarea>
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" 
                                              id="lokasi_proyek" 
                                              name="lokasi_proyek" 
                                              rows="2"><?= htmlspecialchars($suratJalan['lokasi_proyek'] ?? '') ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="sopir" 
                                           name="sopir" 
                                           value="<?= htmlspecialchars($suratJalan['sopir'] ?? '') ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="no_kendaraan" 
                                           name="no_kendaraan" 
                                           value="<?= htmlspecialchars($suratJalan['no_kendaraan'] ?? '') ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="dikirim_oleh" 
                                           name="dikirim_oleh" 
                                           value="<?= htmlspecialchars($suratJalan['dikirim_oleh'] ?? '') ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?= htmlspecialchars($suratJalan['dikirim_telepon'] ?? '') ?>">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" 
                                                  id="catatan_barang" 
                                                  name="catatan_barang" 
                                                  rows="4"><?= htmlspecialchars($suratJalan['catatan_barang'] ?? '') ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" 
                                              id="keterangan" 
                                              name="keterangan" 
                                              rows="3"><?= htmlspecialchars($suratJalan['keterangan'] ?? '') ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-footer bg-light py-3">
                        <div class="d-flex justify-content-between">
                            <a href="<?= base_url('sales/surat-jalan/detail/' . ($suratJalan['id'] ?? '')) ?>" class="btn btn-secondary">
                            ...
                            <div>
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Update Surat Jalan
                                </button>
                            </div>
                        </div>
                    </div>
...
<div class="alert alert-warning alert-dismissible fade show mt-4" role="alert">
    <h5>Debug Data:</h5>
    <pre><?= print_r([
        'suratJalan_keys' => array_keys($suratJalan ?? []),
        'suratJalan_data' => $suratJalan,
...
const existingItems = <?= json_encode($jsItems) ?>;

// Data untuk disiapkan_oleh
const disiapkanData = {
    disiapkan_oleh: '<?= getFieldValue('disiapkan_oleh', $karyawanData['nama_lengkap'] ?? 'Dwi Sales Pratama') ?>',
    disiapkan_telepon: '<?= getFieldValue('disiapkan_telepon', $karyawanData['telepon'] ?? '081234567891') ?>',
    disiapkan_jabatan: '<?= getFieldValue('disiapkan_jabatan', $karyawanData['jabatan'] ?? 'Sales Executive') ?>'
};
...
document.addEventListener('DOMContentLoaded', function() {
    // Inisialisasi items dari database
    initExistingItems();
...
// Fungsi untuk inisialisasi items dari database
...
// Fungsi untuk menambahkan row item
...
function previewSuratJalan() {
    ...
    document.querySelectorAll('.item-row').forEach(row => {
        const item = {
            ...
            keterangan: row.querySelector('.item-keterangan').value || 'Sudah di rakit'
        };
        if (item.nama_barang) {
            items.push(item);
        }
    ...
    // Get project name - gunakan data.project_manual
    const projectName = data.project_manual || '<?= htmlspecialchars($projectName ?? '-') ?>';
    
    // Get invoice number - gunakan data.invoice_manual
    const invoiceNumber = data.invoice_manual || '<?= htmlspecialchars($invoiceNumber ?? '-') ?>';
    let previewHTML = `

        <div class="preview-container" style="font-family: Arial, sans-serif;">
            <div class="header mb-4">
                <h3 class="text-center fw-bold">PREVIEW SURAT JALAN (EDIT)</h3>
                <hr>
            </div>
                ...
                <div class="col-12">
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <p class="mb-1"><strong>Nama:</strong> ${data.disiapkan_oleh || disiapkanData.disiapkan_oleh}</p>
                                </div>
                                <div class="col-md-4">
                                    <p class="mb-1"><strong>Telepon:</strong> ${data.disiapkan_telepon || disiapkanData.disiapkan_telepon}</p>
                                </div>
                                <div class="col-md-4">
                                    <p class="mb-1"><strong>Jabatan:</strong> ${data.disiapkan_jabatan || disiapkanData.disiapkan_jabatan}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>${item.keterangan || 'Sudah di rakit'}</td>
                        </tr>
                        `).join('')}
                    </tbody>
                </table>
            ...
            <div class="row mt-4">
                <div class="col-4 text-center">
                    <p>Disiapkan oleh,</p>
                    <p><strong>${data.disiapkan_oleh || disiapkanData.disiapkan_oleh}</strong></p>
                    <p>${data.disiapkan_jabatan || disiapkanData.disiapkan_jabatan}</p>
                    <p>${data.disiapkan_telepon || disiapkanData.disiapkan_telepon}</p>
                </div>
                <div class="col-4 text-center">
                    <p>Dikirim oleh,</p>
