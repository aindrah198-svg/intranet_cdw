    ...
    <!-- Custom JavaScript -->
    <script>
        // Global salesApp object untuk menghindari duplikasi
        window.salesApp = window.salesApp || {};
        
        // Inisialisasi hanya sekali
        $(document).ready(function() {
            // Cek jika sudah diinisialisasi
            if (window.salesApp.initialized) {
                return;
            }
            
            window.salesApp.initialized = true;
            ...
            $(document).keydown(function(e) {
                ...
                if (e.altKey && e.key === 'd') {
                    e.preventDefault();
                    window.location.href = '<?= base_url("sales/dashboard") ?>';
                }
                
                // Alt+L untuk Leads
                if (e.altKey && e.key === 'l') {
                    e.preventDefault();
                    // window.location.href = '<?= base_url("sales/leads") ?>';
                }
                
                // Alt+Q untuk Quotations
                if (e.altKey && e.key === 'q') {
                    e.preventDefault();
                    // window.location.href = '<?= base_url("sales/quotations") ?>';
                }
            });
