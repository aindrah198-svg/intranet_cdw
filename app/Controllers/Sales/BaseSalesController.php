...
class BaseSalesController extends BaseController
{
    protected $db;
    ...
    {
        if (!$this->db->tableExists('sales_leads')) {
            $this->db->query("
        ...
        if (!$this->db->tableExists('sales_quotation')) {
            $this->db->query("
        ...
        if (!$this->db->tableExists('sales_quotation_item')) {
            $this->db->query("
        ...
        if (!$this->db->tableExists('sales_deal')) {
            $this->db->query("
        ...
        if (!$this->db->tableExists('sales_target')) {
            $this->db->query("
        ...
        if (!$this->db->tableExists('sales_klien')) {
            $this->db->query("
        ...
        if (!$this->db->tableExists('sales_klien_interaksi')) {
            $this->db->query("
